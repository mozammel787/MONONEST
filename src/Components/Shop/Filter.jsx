        ...
        <div className="w-64">
          {priceRanges.map((price) => (
            <label key={price} className="flex items-center justify-between space-x-3 mb-3 cursor-pointer gap-4">
              <span
                className={` flex items-center text-xl font-medium ${selectedPrice === price ? 'text-black' : 'text-gray-400'
                  }`}
              >
                {price}
              ...
              <div className="relative">
                ...
                />
                <div
                  className={`w-6 h-6 border-2 rounded flex justify-center items-center  ${selectedPrice === price
